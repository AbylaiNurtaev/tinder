...
function LogoPage() {
  ...
  useEffect(() => {
    ...
    axios
      .post('/api/validate-init-data', { initData })
      .then((res) => {
        console.log(res.data.user);
        console.log('telegramId', res.data);
      ...
      .finally(() => {
        setTimeout(() => {
          setIsLoaded(true); // Показываем приложение после данных
        }, 300); // Добавляем небольшую задержку для плавного эффекта
      });
  }, []);
